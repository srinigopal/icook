    ...
    export default {
        ...
        methods: {
            ...
            _setupListeners: function() {
                ...
                vueEventBus.$on('select2-selected-single', function(id, optionId) {
                    ...
                    if (id == thisComponent.id) {
                        ...
                        let text = (thisComponent.options[index] != null) ? thisComponent.options[index].text : null;
                        
                        vueEventBus.$emit('selected-honorific', id, optionId, text);
            ...
            getModel: function() {
                ...
                return axios.get('/api/v1/honorific')
                    .then(function(response) {

                        var options = [];

                        _.each(response.data.payload, function(honorific) {
                            options.push({
                                id: honorific.id,
                                text: honorific.name
                            });

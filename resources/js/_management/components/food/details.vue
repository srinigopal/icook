    ...
    <b-card>
      ...
      >
        <div slot="table-actions" class="mb-3">
         <a href="/management/food/add"  > <b-button variant="primary" class="btn-rounded d-none d-sm-block" v-b-modal.modal-1
            ><i class="i-Add-User text-white mr-2"> </i>Add Food Menu
          </b-button></a>
        ...
        <template slot="table-row" slot-scope="props">
          ...
          <span v-if="props.column.field == 'button'">
            ...
            <a :href="'/management/food/edit/' + props.row.id"  >

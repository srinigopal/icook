    ...
    <b-card>
      ...
      >
        <div slot="table-actions" class="mb-3">
         <a href="/management/cuisine/add"> <b-button variant="primary" class="btn-rounded d-none d-sm-block" v-b-modal.modal-1
            ><i class="i-Add-User text-white mr-2"> </i>Add Cuisine
          </b-button>
</a>
        </div>
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'button'">
             <a :href="'/management/cuisine/edit/' + props.row.id"  >
